...
##  Definicion de lo que contiene un Bloque  ##
...
def p_instANDImm(p):
    ...
    p[6] = int(p[7])
    p[0] = {1:"ANDI", 2:p[2], 3:p[4], 4:p[7], 5:"END"}
...
def p_instLSL(p):
    ...
    p[6] = int(p[7])
    p[0] = {1:"LSL", 2:p[2], 3:p[4], 4:p[7], 5:"END"}
...
## Errores manejados por el Compilador  ##
